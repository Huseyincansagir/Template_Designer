...
Portrait (R0/R180) follows the cabin-display stack: logo → floor → direction → door video → rated load. Landscape (R90/R270) keeps the door video on the left third and the indicators on the remaining centre. R180 matches R0; R270 matches R90.
