...
| L-07 (D1-04, D4) | MISSING ENTRY POINT | — | `editWidgetProperties`, the only writer of `content`/`style`, had zero UI call sites. | Orphan capability. | Superseded by `setWidgetConfiguration`, which the inspector calls. | **FIXED** |
